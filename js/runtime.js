...
var now = new Date();
function createtime() {
  var t = new Date("04/01/2023 00:00:00");
  ...
  (g =
    r < 18 && r >= 9
      ? `<img class='boardsign' src='/img/badge/calyee-上班摸鱼中.svg' title='大佬带带我~'><span class='textTip'> <br> 本站居然运行了 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-heartbeat' style='color:red'></i>`
      : `<img class='boardsign' src='/img/badge/calyee-下班啦.svg' title='下班了就该开开心心的玩耍，嘿嘿~'><span class='textTip'> <br> 本站居然运行了 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-heartbeat' style='color:red'></i>`),
